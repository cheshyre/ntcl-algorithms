module async_cuda_permute_driver_module
    ...
    public :: async_cuda_permute_driver

    type, extends(raw_tensor_permute) :: async_cuda_permute_driver
    ...
    end type async_cuda_permute_driver

    interface async_cuda_permute_driver
        module procedure constructor_empty
        module procedure constructor
    end interface async_cuda_permute_driver

    interface
        subroutine cuda_tensor_permute_generic_real32_execute(d_src, d_dst, number_of_elements, &
                    d_sdims, d_perm, order, astream) &
                    bind(C, name="cuda_tensor_permute_async_real32_execute")
            import :: c_ptr
            import :: c_int
            import :: c_int64_t
        ...
        subroutine cuda_tensor_permute_generic_real64_execute(d_src, d_dst, number_of_elements, &
                    d_sdims, d_perm, order, astream) &
                    bind(C, name="cuda_tensor_permute_async_real64_execute")
            import :: c_ptr
            import :: c_int
            import :: c_int64_t
        ...
        subroutine cuda_tensor_permute_generic_complex64_execute(d_src, d_dst, number_of_elements, &
                    d_sdims, d_perm, order, astream) &
                    bind(C, name="cuda_tensor_permute_async_complex64_execute")
            import :: c_ptr
            import :: c_int
            import :: c_int64_t
        ...
        subroutine cuda_tensor_permute_generic_complex128_execute(d_src, d_dst, number_of_elements, &
                    d_sdims, d_perm, order, astream) &
                    bind(C, name="cuda_tensor_permute_async_complex128_execute")
            import :: c_ptr
            import :: c_int
            import :: c_int64_t
...
contains
    function constructor_empty() result(this)
        type(async_cuda_permute_driver) :: this
    ...
    function constructor(builder, converter, pinned_scratch, device_scratch) result(this)
        ...
        this = async_cuda_permute_driver()
    ...
    subroutine set_builder(this, builder)
        class(async_cuda_permute_driver), intent(inout) :: this
        type(tensor_builder), intent(in) :: builder
    ...
    subroutine permute_tensor(this, src, dst, perm, astream)
        ...
        if ( .not. this%is_compatible(src, dst, perm) ) &
                error stop "async_cuda_permute_driver::permute_tensor:Tensors are not compatible."
        ...
        case ( dt_c128 )
            call cuda_tensor_permute_generic_complex128_execute( &
                    ...
                    device_dims_cptr, device_perms_cptr, src%get_rank(), actual_stream)
        case default
            error stop "async_cuda_permute_driver::permute_tensor:Datatype not supported."
        end select
    ...
    subroutine release_buffered_data(this, dims, perms, scratch, astream)
        class(async_cuda_permute_driver), intent(in) :: this
    ...
    subroutine synchronize(this, astream)
        ...
        if (error /= 0) &
                error stop "async_cuda_permute_driver::synchronize:Error in call to synchronize wrapper."
...
end module async_cuda_permute_driver_module
